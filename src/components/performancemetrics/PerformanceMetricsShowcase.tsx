// src/components/performancemetrics/PerformanceMetricsShowcase.tsx
...
const SAMPLE_EQUITY_CURVE = Array.from({ length: 30 }, (_, i) => {
  const date = new Date();
...
// Continuing src/components/performancemetrics/PerformanceMetricsShowcase.tsx
...
const FrameworkSelector = () => {
      ...
      <div className="flex flex-col gap-4 p-4 bg-white rounded-lg border border-neutral-200">
        ...
        <div>
          <label className="flex items-center gap-2">
            ...
            />
            <span className="text-sm font-medium text-neutral-700">Show Equity Curve</span>
          </label>
        </div>
      </div>
    );
    ...
    return (
      <div className={`p-6 rounded-lg ${bgColor}`}>
        <PerformanceMetrics
          ...
          equityCurve={SAMPLE_EQUITY_CURVE}
          {...config}
        />
      </div>
    );
  ...
  export const PerformanceMetricsShowcase = () => {
  ...
  export default PerformanceMetricsShowcase;
